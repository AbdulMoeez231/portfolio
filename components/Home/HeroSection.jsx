        ...
        <div className='min-h-screen'>
            ...
            <div className=' container flex items-end justify-between fade-in '>
                <div className='pop-up'>
                    <h1 className='text-white text-3xl sm:text-4xl font-extrabold mt-5' style={{ lineHeight: "55px" }}>Hi, <br className='sm:hidden' /> I'm <span className='text-gradient'>Abdul Moeez.</span> <br />
                ...
                <div className='max-lg:hidden'>
                    <div className='icon-animation'>
                        <svg xmlns="http://www.w3.org/2000/svg" width="350" height="350" viewBox="0 0 24 24" fill="none" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="icon icon-tabler icons-tabler-outline icon-tabler-code">
                            <defs>
                                <linearGradient id="gradient1" x1="0%" x2="100%" y1="0%" y2="0%">
                                    <stop offset="0%" stop-color="rgb(255, 7, 7)" />
                                    <stop offset="100%" stop-color="rgb(255, 255, 5)" />
                                </linearGradient>
                            </defs>
                            <path stroke="url(#gradient1)" d="M7 8l-4 4l4 4" />
                            <path stroke="yellow" d="M14 4l-4 16" />
